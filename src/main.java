...
public class main {
    public static void main(String[] args) {
        Items item1=new Items("jacket",4444,"Lewis",3999,200);
        Items item2=new Items("tshirt",4448,"Gucci",9999,600);
        Items item3=new Items("shirt",8444,"Luis Vinton",4899,0);
        Items item4=new Items("tshirt",4467,"Luis Vinton",5999,809);
        Items item5=new Items("tshirt",4456,"Luis Vinton",7999,401);
